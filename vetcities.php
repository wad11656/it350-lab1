...
if ((!isset($_GET['user'])) || (!isset($_GET['secretkey']))){
	...
	echo "( Example: <b>http://40.117.58.200/it350site/vetcities.php?user=my_user&secretkey=my_secretkey</b> )";
	$validparams = FALSE;
	exit;
}
...
if ($validparams == TRUE){
	$sql = 'SELECT DISTINCT city FROM veterinarian';
	// Set rows_affected
	$rows_affected = 0;
	...
	echo "Error: " . $mysqli->error . "<br />\n";
		echo "<i>( Example: <b>http://40.117.58.200/it350site/vetcities.php?user=my_user&secretkey=my_secretkey</b> )</i>";
		$validparams = FALSE;
		exit;
	}
